...
Usage:
    ...
    python agents/hooks/generate_skill_wrappers.py --dry-run
    python agents/hooks/generate_skill_wrappers.py --clean
    python agents/hooks/generate_skill_wrappers.py --output-dir agents/logic/skills_wrappers
"""
