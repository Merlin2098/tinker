...
1. `mode_profile` in `agents/logic/user_task.yaml` (if set)
2. `agents/logic/agent_outputs/runtime/active_profile.<agent-id>.json` (if present)
3. `agents/logic/agent_outputs/runtime/active_profile.json`
4. default `LITE`
