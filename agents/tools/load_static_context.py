...
SKILLS_PATH = os.path.join("agents", "logic", "skills", "_index.yaml")
AGENT_RULES_PATH = os.path.join("agents", "logic", "rules", "agent_rules.md")
SCHEMAS_PATH = os.path.join("agents", "logic", "agent_protocol", "schemas")
...
_DEFAULT_EXCLUDED_FROM_SIGNATURES = {"agents/logic/skills"}
...
def _extract_python_signatures(
    ...
    for dirpath, dirnames, filenames in os.walk(root):
        ...
        # Skip directories excluded from signatures (e.g. agents/logic/skills)
...
def load_static_context(profile: Optional[str] = None) -> Dict[str, Any]:
    ...
    if os.path.exists(SKILLS_PATH):
        ...
        context["skills_registry"] = {
            ...
            "_note": "Live registry from _index.yaml. Full details in agents/logic/skills/.",
            "_index_path": "agents/logic/skills/_index.yaml",
            "_trigger_engine_path": "agents/logic/skills/_trigger_engine.yaml",
        }
    else:
        context["skills_registry"] = {}
    ...
    # 5. Python signatures — class/function index (.gitignore respected, agents/logic/skills excluded)
...
def save_static_context_as_json(
    context: Dict[str, Any],
    output_path: str = "agents/logic/agent_outputs/context.json",
