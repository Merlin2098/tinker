...
Usage:
  .venv/Scripts/python.exe agents/tools/run_wrapper.py --skill connect_duckdb --args-json '{"database_path":"data/example.duckdb"}'
  .venv/Scripts/python.exe agents/tools/run_wrapper.py --skill load_json_files --args-file agents/logic/agent_outputs/plans/load_json.args.json
"""
