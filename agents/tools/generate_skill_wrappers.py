#!/usr/bin/env python3
"""
Generate compatibility SKILL.md wrappers from agents/logic/skills/_index.yaml.
...
Usage:
    ...
    python agents/tools/generate_skill_wrappers.py --dry-run
    python agents/tools/generate_skill_wrappers.py --clean
    python agents/tools/generate_skill_wrappers.py --output-dir agents/logic/skills_wrappers
"""
...
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "agents" / "logic" / "skills_wrappers"
