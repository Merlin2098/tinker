...
- `agents/logic/agent_inspector/agent_inspector.md`
- `agents/logic/agent_executor/agent_executor.md`
...
- `agents/logic/agent_outputs/` — plans, reports, artifacts
- `agents/logic/agent_logs/` — execution logs
- `agents/logic/temp/` — temporary agent files
- `agents/logic/skills/` — authoritative skill definitions
...
protected_files:
  documentation:
    ...
    - agents/logic/architecture_proposal.md
    - agents/logic/agent_inspector/agent_inspector.md
    - agents/logic/agent_executor/agent_executor.md
    - agents/logic/agent_protocol/README.md
    - README.md
    - agents/logic/skills/_index.yaml
    - agents/logic/skills/_trigger_engine.yaml
...
The authoritative implementation of this policy resides under: `agents/logic/skills/runtime/`
...
- Outputs MUST be stored under `agents/logic/agent_outputs/`
...
| :--- | :--- |
| `Initiate Tinker` | `$env:PYTHONIOENCODING='utf-8'; ./.venv/Scripts/python.exe agents/tools/chat_shortcuts.py init` |
| `Initiate Tinker. Kernel LITE` | `$env:PYTHONIOENCODING='utf-8'; ./.venv/Scripts/python.exe agents/tools/chat_shortcuts.py init --profile LITE` |
| `Initiate Tinker. Kernel STANDARD` | `$env:PYTHONIOENCODING='utf-8'; ./.venv/Scripts/python.exe agents/tools/chat_shortcuts.py init --profile STANDARD` |
| `Initiate Tinker. Kernel FULL` | `$env:PYTHONIOENCODING='utf-8'; ./.venv/Scripts/python.exe agents/tools/chat_shortcuts.py init --profile FULL` |
