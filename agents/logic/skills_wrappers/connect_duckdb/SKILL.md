...
## Source Files
- Body (Layer 3): `agents/logic/skills/database/connect_duckdb.md`
- Metadata (Layer 2): `agents/logic/skills/database/connect_duckdb.meta.yaml`
