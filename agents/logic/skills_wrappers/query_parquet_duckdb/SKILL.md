...
## Source Files
- Body (Layer 3): `agents/logic/skills/database/query_parquet_duckdb.md`
- Metadata (Layer 2): `agents/logic/skills/database/query_parquet_duckdb.meta.yaml`
