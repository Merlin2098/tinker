...
## Source Files
- Body (Layer 3): `agents/logic/skills/debugging/debugger_orchestrator.md`
- Metadata (Layer 2): `agents/logic/skills/debugging/debugger_orchestrator.meta.yaml`
