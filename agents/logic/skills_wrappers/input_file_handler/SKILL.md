...
## Source Files
- Body (Layer 3): `agents/logic/skills/file_handling/input_file_handler.md`
- Metadata (Layer 2): `agents/logic/skills/file_handling/input_file_handler.meta.yaml`
