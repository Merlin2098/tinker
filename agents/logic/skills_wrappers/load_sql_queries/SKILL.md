...
- Priority: `50`
- Purpose: Load SQL query files through canonical wrapper execution

## Source Files
- Body (Layer 3): `agents/logic/skills/formats/load_sql_queries.md`
- Metadata (Layer 2): `agents/logic/skills/formats/load_sql_queries.meta.yaml`
