...
## Source Files
- Body (Layer 3): `agents/logic/skills/debugging/root_cause_tracing.md`
- Metadata (Layer 2): `agents/logic/skills/debugging/root_cause_tracing.meta.yaml`
