...
- Priority: `45`
- Purpose: Externalize logic into rules, DSLs, config-driven templates

## Source Files
- Body (Layer 3): `agents/logic/skills/python/externalized_logic_handler.md`
- Metadata (Layer 2): `agents/logic/skills/python/externalized_logic_handler.meta.yaml`
