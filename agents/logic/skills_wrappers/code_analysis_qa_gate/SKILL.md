...
## Source Files
- Body (Layer 3): `agents/logic/skills/python/code_analysis_qa_gate.md`
- Metadata (Layer 2): `agents/logic/skills/python/code_analysis_qa_gate.meta.yaml`
