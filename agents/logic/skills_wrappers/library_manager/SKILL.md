...
## Source Files
- Body (Layer 3): `agents/logic/skills/devops/library_manager.md`
- Metadata (Layer 2): `agents/logic/skills/devops/library_manager.meta.yaml`
