# SKILL.md - refactoring_assistant
...
## Source Files
- Body (Layer 3): `agents/logic/skills/python/refactoring_assistant.md`
- Metadata (Layer 2): `agents/logic/skills/python/refactoring_assistant.meta.yaml`
