...
## Source Files
- Body (Layer 3): `agents/logic/skills/formats/load_yaml_files.md`
- Metadata (Layer 2): `agents/logic/skills/formats/load_yaml_files.meta.yaml`
