...
## Source Files
- Body (Layer 3): `agents/logic/skills/file_exploration/parquet_explorer.md`
- Metadata (Layer 2): `agents/logic/skills/file_exploration/parquet_explorer.meta.yaml`
