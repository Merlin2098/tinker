...
## Source Files
- Body (Layer 3): `agents/logic/skills/observability/log_bundle_folder_management.md`
- Metadata (Layer 2): `agents/logic/skills/observability/log_bundle_folder_management.meta.yaml`
