# SKILL.md - code_structuring_pythonic
...
## Source Files
- Body (Layer 3): `agents/logic/skills/python/code_structuring_pythonic.md`
- Metadata (Layer 2): `agents/logic/skills/python/code_structuring_pythonic.meta.yaml`
