...
## Source Files
- Body (Layer 3): `agents/logic/skills/observability/log_overwrite_policy.md`
- Metadata (Layer 2): `agents/logic/skills/observability/log_overwrite_policy.meta.yaml`
