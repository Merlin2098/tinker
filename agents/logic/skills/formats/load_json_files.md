...
- `agents/tools/wrappers/load_json_files_wrapper.py`
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill load_json_files --args-json "{\"path\":\"agents/logic/agent_outputs/context.json\"}"
```

Preferred with args file:

```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill load_json_files --args-file agents/logic/agent_outputs/plans/load_json_files.args.json
```
