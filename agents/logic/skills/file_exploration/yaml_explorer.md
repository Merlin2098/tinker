...
- `agents/tools/wrappers/yaml_explorer_wrapper.py`
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill yaml_explorer --args-json "{\"path\":\"agents/logic/user_task.yaml\"}"
```
