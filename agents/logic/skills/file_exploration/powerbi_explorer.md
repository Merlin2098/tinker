...
- `agents/tools/wrappers/powerbi_explorer_wrapper.py`
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill powerbi_explorer --args-json "{\"path\":\"reports/model.pbix\"}"
```
