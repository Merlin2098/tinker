...
- `agents/tools/wrappers/parquet_explorer_wrapper.py`
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill parquet_explorer --args-json "{\"path\":\"data/sample.parquet\"}"
```
