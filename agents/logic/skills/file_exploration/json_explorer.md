...
- `agents/tools/wrappers/json_explorer_wrapper.py`
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill json_explorer --args-json "{\"path\":\"agents/logic/agent_outputs/context.json\"}"
```
