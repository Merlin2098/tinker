...
- `agents/tools/wrappers/markdown_explorer_wrapper.py`
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill markdown_explorer --args-json "{\"path\":\"README.md\"}"
```
