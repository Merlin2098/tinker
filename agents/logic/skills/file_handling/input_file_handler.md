...
- `agents/tools/wrappers/input_file_handler_wrapper.py`
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill input_file_handler --args-json "{\"path\":\"agents/logic/agent_outputs/context.json\",\"allowed_extensions\":[\".json\"]}"
```
