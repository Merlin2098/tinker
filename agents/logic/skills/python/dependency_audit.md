# Skill: dependency_audit (Thin Interface)

## Purpose
Security vulns, compatibility, licensing audit
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill dependency_audit --args-json "{\"objective\":\"<goal>\"}"
```
