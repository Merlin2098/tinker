# Skill: devops_packaging (Thin Interface)

## Purpose
Python packaging via setup.py/pyproject.toml
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill devops_packaging --args-json "{\"objective\":\"<goal>\"}"
```
