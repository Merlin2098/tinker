# Skill: secure_python_practices (Thin Interface)
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill secure_python_practices --args-json "{\"objective\":\"<goal>\"}"
```
