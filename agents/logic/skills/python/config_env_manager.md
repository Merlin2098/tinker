# Skill: config_env_manager (Thin Interface)

## Purpose
Config and env vars with dotenv, multi-environment
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill config_env_manager --args-json "{\"objective\":\"<goal>\"}"
```
