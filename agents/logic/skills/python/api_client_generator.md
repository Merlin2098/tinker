# Skill: api_client_generator (Thin Interface)

## Purpose
Type-safe API clients for REST/GraphQL
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill api_client_generator --args-json "{\"objective\":\"<goal>\"}"
```
