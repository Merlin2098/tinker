# Skill: refactoring_assistant (Thin Interface)

## Purpose
Systematic refactoring: readability, deduplication, simplification
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill refactoring_assistant --args-json "{\"objective\":\"<goal>\"}"
```
