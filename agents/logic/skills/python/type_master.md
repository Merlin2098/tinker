# Skill: type_master (Thin Interface)

## Purpose
Type hints, Mypy/Pyright, Pydantic runtime validation
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill type_master --args-json "{\"objective\":\"<goal>\"}"
```
