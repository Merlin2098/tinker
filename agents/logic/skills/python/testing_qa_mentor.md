# Skill: testing_qa_mentor (Thin Interface)

## Purpose
Pytest, fixtures, parametrization, Hypothesis, mocking
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill testing_qa_mentor --args-json "{\"objective\":\"<goal>\"}"
```
