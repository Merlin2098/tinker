# Skill: decision_process_flow (Thin Interface)

## Purpose
Structured decision-making: validation, impact analysis, scoring, plan generation
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill decision_process_flow --args-json "{\"objective\":\"<goal>\"}"
```
