# Skill: llm_inference_optimization (Thin Interface)

## Purpose
Token budget, context pruning at 60%, temperature selection
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill llm_inference_optimization --args-json "{\"objective\":\"<goal>\"}"
```
