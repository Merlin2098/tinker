# Skill: brainstorming_design_explorer (Thin Interface)

## Purpose
Pre-planning design exploration with 2-3 approaches and YAGNI enforcement
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill brainstorming_design_explorer --args-json "{\"objective\":\"<goal>\"}"
```
