# Skill: ui_splash_and_lazy_loading (Thin Interface)

## Purpose
Splash screens during resource loading

Business logic lives in:
- `agents/tools/wrappers/ui_advisor_wrapper.py`
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill ui_splash_and_lazy_loading --args-json "{\"objective\":\"<goal>\"}"
```
