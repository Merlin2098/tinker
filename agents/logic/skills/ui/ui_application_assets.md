# Skill: ui_application_assets (Thin Interface)

## Purpose
Centralized asset management (icons, images)
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill ui_application_assets --args-json "{\"objective\":\"<goal>\"}"
```
