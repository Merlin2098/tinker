# Skill: ui_theme_binding (Thin Interface)

## Purpose
Reactive theme system with light/dark mode
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill ui_theme_binding --args-json "{\"objective\":\"<goal>\"}"
```
