# Skill: ui_identity_policy (Thin Interface)

## Purpose
App identity (name, version) without redundancy
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill ui_identity_policy --args-json "{\"objective\":\"<goal>\"}"
```
