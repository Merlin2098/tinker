# Skill: ui_framework_selection (Thin Interface)

## Purpose
Tkinter for MVP, PySide6 for production
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill ui_framework_selection --args-json "{\"objective\":\"<goal>\"}"
```
