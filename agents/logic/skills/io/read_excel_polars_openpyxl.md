...
- `agents/tools/wrappers/read_excel_polars_openpyxl_wrapper.py`
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill read_excel_polars_openpyxl --args-json "{\"path\":\"data/data_papa.xlsx\",\"sheet_name\":0}"
```

Preferred with args file:

```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill read_excel_polars_openpyxl --args-file agents/logic/agent_outputs/plans/read_excel_polars_openpyxl.args.json
```
