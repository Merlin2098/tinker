...
- `agents/tools/wrappers/log_overwrite_policy_wrapper.py`
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill log_overwrite_policy --args-json "{\"log_file_path\":\"logs/execution.log\"}"
```
