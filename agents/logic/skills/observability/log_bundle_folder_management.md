...
- `agents/tools/wrappers/log_bundle_folder_management_wrapper.py`
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill log_bundle_folder_management --args-json "{\"bundled_mode\":true}"
```
