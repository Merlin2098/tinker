# Skill: path_traversal_prevention (Thin Interface)

## Purpose
Prevents path traversal attacks and sandbox escapes
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill path_traversal_prevention --args-json "{\"objective\":\"<goal>\"}"
```
