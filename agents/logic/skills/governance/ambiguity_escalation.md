# Skill: ambiguity_escalation (Thin Interface)

## Purpose
Escalates unclear requirements instead of guessing
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill ambiguity_escalation --args-json "{\"objective\":\"<goal>\"}"
```
