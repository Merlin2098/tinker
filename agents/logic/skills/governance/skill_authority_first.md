# Skill: skill_authority_first (Thin Interface)

## Purpose
Skills are authoritative units invoked BEFORE any agent action
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill skill_authority_first --args-json "{\"objective\":\"<goal>\"}"
```
