# Skill: immutable_resource_respect (Thin Interface)

## Purpose
Prevents modification of immutable resources and protected infrastructure
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill immutable_resource_respect --args-json "{\"objective\":\"<goal>\"}"
```
