# Skill: minimal_documentation_policy (Thin Interface)
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill minimal_documentation_policy --args-json "{\"objective\":\"<goal>\"}"
```
