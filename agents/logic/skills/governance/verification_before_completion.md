# Skill: verification_before_completion (Thin Interface)

## Purpose
Fresh evidence required before any completion claims
...
```bash
.venv/Scripts/python.exe agents/tools/run_wrapper.py --skill verification_before_completion --args-json "{\"objective\":\"<goal>\"}"
```
