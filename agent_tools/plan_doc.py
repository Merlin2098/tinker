...
This tool manages review/handoff plan artifacts under:
  - agent/agent_outputs/plans/plan_active/
  - agent/agent_outputs/plans/archive/
...
DEFAULT_ACTIVE_DIR = ROOT / "agent" / "agent_outputs" / "plans" / "plan_active"
DEFAULT_ARCHIVE_DIR = ROOT / "agent" / "agent_outputs" / "plans" / "archive"
DEFAULT_SCHEMA = ROOT / "agent" / "agent_protocol" / "schemas" / "plan_doc.schema.yaml"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_validate.add_argument(
        ...
        help="Schema path (default: agent/agent_protocol/schemas/plan_doc.schema.yaml).",
    )
