...
Usage examples:
  python agent_tools/git_checkpoint.py commit --message "checkpoint: update docs"
  python agent_tools/git_checkpoint.py sync
  python agent_tools/git_checkpoint.py commit-sync --message "checkpoint: complete rework slice"
"""
