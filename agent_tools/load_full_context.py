...
def save_context_as_json(full_context: Dict[str, Any], output_path: str = "agent/agent_outputs/context.json") -> None:
...
def main() -> int:
    ...
    parser.add_argument(
        "--task-plan",
        default="agent/agent_outputs/plans/task_plan.json",
    ...
    parser.add_argument(
        "--summary",
        default="agent/agent_outputs/summary/summary.yaml",
    ...
    parser.add_argument(
        "--output",
        default="agent/agent_outputs/context.json",
