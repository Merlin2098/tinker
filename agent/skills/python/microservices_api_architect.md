# Skill: microservices_api_architect (Thin Interface)

## Purpose
FastAPI/Flask APIs with DDD and OpenAPI
...
```bash
.venv/Scripts/python.exe agent_tools/run_wrapper.py --skill microservices_api_architect --args-json "{\"objective\":\"<goal>\"}"
```
