...
- `agent_tools/wrappers/excel_to_parquet_wrapper.py`
...
```bash
.venv/Scripts/python.exe agent_tools/run_wrapper.py --skill excel_to_parquet --args-json "{\"source_excel_path\":\"data/data_papa.xlsx\",\"target_parquet_path\":\"data/data_papa.parquet\"}"
```

Preferred with args file:

```bash
.venv/Scripts/python.exe agent_tools/run_wrapper.py --skill excel_to_parquet --args-file agent/agent_outputs/plans/excel_to_parquet.args.json
```
