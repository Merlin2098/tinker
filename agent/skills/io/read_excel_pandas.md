...
- `agent_tools/wrappers/read_excel_pandas_wrapper.py`
...
```bash
.venv/Scripts/python.exe agent_tools/run_wrapper.py --skill read_excel_pandas --args-json "{\"path\":\"data/data_papa.xlsx\"}"
```

Preferred with args file:

```bash
.venv/Scripts/python.exe agent_tools/run_wrapper.py --skill read_excel_pandas --args-file agent/agent_outputs/plans/read_excel_pandas.args.json
```
