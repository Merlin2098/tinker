...
- `agent_tools/wrappers/generate_exe_pyinstaller_onedir_wrapper.py`
...
```bash
.venv/Scripts/python.exe agent_tools/run_wrapper.py --skill generate_exe_pyinstaller_onedir --args-json "{\"script_path\":\"src/app.py\"}"
```
