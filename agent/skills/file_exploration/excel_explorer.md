...
- `agent_tools/wrappers/excel_explorer_wrapper.py`
...
```bash
.venv/Scripts/python.exe agent_tools/run_wrapper.py --skill excel_explorer --args-json "{\"path\":\"data/data_papa.xlsx\"}"
```
