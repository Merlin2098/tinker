...
## Purpose
Agents respect workspace model â€” agent/ writable, source protected
...
```bash
.venv/Scripts/python.exe agent_tools/run_wrapper.py --skill workspace_model_awareness --args-json "{\"objective\":\"<goal>\"}"
```
