...
| `wrapper_code` | string | Complete Python code for `agent_tools/wrappers/<name>_wrapper.py`. |
...
2.  **Generation**:
    -   Writes `agent/skills/<cluster>/<skill_name>.md`
    -   Writes `agent/skills/<cluster>/<skill_name>.meta.yaml`
    -   Writes `agent_tools/wrappers/<skill_name>_wrapper.py`
