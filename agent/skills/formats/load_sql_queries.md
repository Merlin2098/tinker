...
- `agent_tools/wrappers/load_sql_queries_wrapper.py`
...
```bash
.venv/Scripts/python.exe agent_tools/run_wrapper.py --skill load_sql_queries --args-json "{\"path\":\"queries/example.sql\"}"
```

Preferred with args file:

```bash
.venv/Scripts/python.exe agent_tools/run_wrapper.py --skill load_sql_queries --args-file agent/agent_outputs/plans/load_sql_queries.args.json
```
