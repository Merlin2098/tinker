...
- `agent_tools/wrappers/load_yaml_files_wrapper.py`
...
```bash
.venv/Scripts/python.exe agent_tools/run_wrapper.py --skill load_yaml_files --args-json "{\"path\":\"agent/user_task.yaml\"}"
```

Preferred with args file:

```bash
.venv/Scripts/python.exe agent_tools/run_wrapper.py --skill load_yaml_files --args-file agent/agent_outputs/plans/load_yaml_files.args.json
```
