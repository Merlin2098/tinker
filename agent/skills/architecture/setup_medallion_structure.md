...
- `agent_tools/wrappers/setup_medallion_structure_wrapper.py`
...
```bash
.venv/Scripts/python.exe agent_tools/run_wrapper.py --skill setup_medallion_structure --args-json "{\"base_path\":\"data/lake\",\"validate_only\":true}"
```
