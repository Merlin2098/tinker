...
2. Do not infer missing fields. Do not invent missing intent.
3. If `Phase = A_CONTRACT_VALIDATION`, return explicit contract verdict.
4. If `Phase = B_EXECUTION` and `Validation Status != PASSED`, stop.
5. Do not assume config location; consume only declared `Config`.

## 3. Execution References
- Context: `agent/agent_inspector/context/context.md`
- Workflow: `agent/agent_inspector/workflow/workflow.md`
