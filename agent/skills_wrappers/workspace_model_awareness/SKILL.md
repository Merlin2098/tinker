...
- Cluster: `governance`
- Priority: `99`
- Purpose: Agents respect workspace model — agent/ writable, source protected

## Source Files
- Body (Layer 3): `agent/skills/governance/workspace_model_awareness.md`
- Metadata (Layer 2): `agent/skills/governance/workspace_model_awareness.meta.yaml`
