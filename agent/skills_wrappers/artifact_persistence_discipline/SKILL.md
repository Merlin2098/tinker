...
## Source Files
- Body (Layer 3): `agent/skills/governance/artifact_persistence_discipline.md`
- Metadata (Layer 2): `agent/skills/governance/artifact_persistence_discipline.meta.yaml`
